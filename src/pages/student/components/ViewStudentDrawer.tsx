...
import { getStudentDetail } from '../service';
...
const ViewStudentDrawer: React.FC<Props> = ({ id, open, onClose }) => {
  ...
  useEffect(() => {
    ...
    getStudentDetail(id)
      .then((res) => {
        ...
        else messageApi.error('Không tải được thông tin học viên');
      })
      .catch(() => messageApi.error('Không tải được thông tin học viên'))

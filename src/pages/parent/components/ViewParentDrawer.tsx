...
import { getParentDetail } from '../service';
...
const ViewParentDrawer: React.FC<Props> = ({ id, open, onClose }) => {
  ...
  useEffect(() => {
    ...
    getParentDetail(id)
      .then((res) => {
        ...
        else messageApi.error('Không tải được thông tin phụ huynh');
      })
      .catch(() => messageApi.error('Không tải được thông tin phụ huynh'))
...
export default ViewParentDrawer;
